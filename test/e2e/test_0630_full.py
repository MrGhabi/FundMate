"""
End-to-end test for 0630 dataset.
...
def load_expected_results():
    ...
    if baseline_file.exists():
        with open(baseline_file) as f:
            data = json.load(f)
            return data['0630'], data['tolerance_percent']
    # Fallback to hardcoded values if file missing
    return {
        'total_cash': 39_882_283.91,
        'total_positions': 59_362_678.62,
        'grand_total': 99_244_962.53
    }, 5.0
...
@pytest.mark.e2e
class TestE2E_0630:
    """End-to-end test simulating: python src/main.py data/20250630_Statement --date 2025-06-30"""
    
    def test_full_pipeline_0630(self, broker_folder_0630, test_date_0630, project_root_path):
        """
